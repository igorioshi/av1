...
class AlunosControllerTest < ActionController::TestCase
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post :create, aluno: { curso: @aluno.curso, email-lasalle: @aluno.email-lasalle, email-pessoal: @aluno.email-pessoal, matricula: @aluno.matricula, nome: @aluno.nome }
    end
  ...
  test "should update aluno" do
    patch :update, id: @aluno, aluno: { curso: @aluno.curso, email-lasalle: @aluno.email-lasalle, email-pessoal: @aluno.email-pessoal, matricula: @aluno.matricula, nome: @aluno.nome }
    assert_redirected_to aluno_path(assigns(:aluno))
  end
